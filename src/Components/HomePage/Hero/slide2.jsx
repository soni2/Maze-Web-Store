...
export default function Slide2() {
  return (
    <div className="grid grid-cols-2 max-w-[1800px] gap-12">
      <div
        src="/hero2.webp"
        alt="Hero"
        className="bg-[url('/hero2.webp')] bg-right-bottom bg-cover bg-no-repeat  mx-auto overflow-hidden object-cover w-full h-full"
      />
      <div className="w-full h-full flex items-start justify-center flex-col gap-8 justify-items-end">
