      ...
      <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16 duration-1000">
        ...
        <div className="flex flex-col items-start space-y-4">
          <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
            Dominate the game. Unleash unparalleled power with the latest Intel
            processor, lightning-fast SSD storage, and immersive graphics.
            Elevate your gaming experience to new heights with the ultimate
            gaming machine.
          </p>
